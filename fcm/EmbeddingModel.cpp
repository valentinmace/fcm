...
// POUR WINDOWS /////////////////////////////
// Si tu l'enl?ves renomme le "posix_memalign"
...
int pposix_memalign(void **ptr, size_t align, size_t size)
{
...
void EmbeddingModel::InitNet() {
    long long a, b;
    a = pposix_memalign((void **)&syn0, 128, (long long)vocab_size * layer1_size * sizeof(real));
    if (syn0 == NULL) {printf("Memory allocation failed\n"); exit(1);}
    a = pposix_memalign((void **)&syn1neg, 128, (long long)vocab_size * layer1_size * sizeof(real));
...
void EmbeddingModel::InitNetHS() {
    long long a,b;
    a = pposix_memalign((void **)&syn1, 128, (long long)vocab_size * layer1_size * sizeof(real));
